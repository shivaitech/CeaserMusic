      ...
      <div className="fixed top-6 left-0 w-full z-50 flex justify-center pointer-events-none">
        <nav className="pointer-events-auto bg-[#f2f2f2]/80 backdrop-blur-xl border border-white/50 shadow-lg rounded-full px-4 py-2 flex items-center gap-3 md:gap-8 max-w-[95%] md:max-w-none justify-between md:justify-center">
          ...
          <div className="flex items-center gap-3 md:gap-4 text-black/60">
            <a
              href="https://www.instagram.com/az________ur?igsh=MWpmd2ZlbzB0dnhsbw=="
              target="_blank"
            ...
            <a
              href="https://wa.me/971507106188?text=Hi%2C%20I%27m%20interested%20in%20the%20%5BAZ%3AUR%5D%20Membership%20Infrastructure"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 font-bold text-sm tracking-tight hover:text-[#25D366] transition-colors p-1"
            >
          ...
          <button className="bg-black text-white px-4 py-2 md:px-5 md:py-2.5 rounded-full font-bold text-xs md:text-sm flex items-center gap-2 hover:bg-neon hover:text-white transition-colors shadow-xl group whitespace-nowrap">
            <div className="w-4 h-4 md:w-5 md:h-5 bg-white rounded flex items-center justify-center text-black group-hover:text-neon transition-colors">
              <span className="font-condensed text-[8px] md:text-[10px] leading-none pt-0.5">
                AZ
              </span>
            </div>
            Request Access
      ...
      <main className="max-w-[1400px] mx-auto pt-32 md:pt-40 px-4 md:px-8 pb-20 overflow-x-hidden">
        ...
        <section className="text-center relative mb-24 md:mb-40">
          ...
          <div className="relative z-10 mt-12 md:mt-16 mb-20 w-full flex justify-center">
            ...
            <div className="absolute top-[20%] left-[5%] md:left-[25%] animate-float hidden md:block">
              <div className="bg-black/90 backdrop-blur-md text-white px-6 py-3 rounded-full border border-white/10 shadow-2xl flex items-center gap-3 hover:scale-105 transition-transform cursor-default">
                ...
                <div className="text-left">
                  <div className="font-condensed uppercase text-lg leading-none">
                    Status
                  </div>
            ...
            <div
              className="absolute bottom-[20%] right-[5%] md:right-[25%] animate-float hidden md:block"
        ...
        <section className="mb-24 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8 max-w-[1300px] mx-auto">
            ...
            <div className="bg-gray-100 rounded-[2.5rem] p-8 md:p-16 text-left flex flex-col justify-center min-h-[400px] md:min-h-[500px] border border-gray-200 relative overflow-hidden group">
              <p className="font-bold text-gray-400 text-xs md:text-sm uppercase tracking-widest mb-12 absolute top-8 left-8 md:top-10 md:left-16">
                ( OLD WAY )
              </p>
              <div className="space-y-8 md:space-y-12 relative z-10 mt-8 md:mt-0">
                <div className="flex items-start gap-4 md:gap-6 opacity-60 md:opacity-40 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="mt-1 md:mt-2">
                    <X size={24} className="text-gray-400 md:w-8 md:h-8" />
                  </div>
                  <div>
                    <h3 className="font-condensed text-4xl md:text-6xl text-gray-400 leading-[0.9] mb-1 md:mb-2">
                      EXPENSIVE ADS
                    </h3>
                    <p className="text-gray-400 text-sm md:text-base font-medium">
                      You pay for reach you don't own.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 md:gap-6 opacity-60 md:opacity-40 group-hover:opacity-100 transition-opacity duration-500 delay-200">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm md:text-base font-medium">
                      You build their platform, not yours.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-neon rounded-[2.5rem] p-8 md:p-16 text-left flex flex-col justify-center min-h-[400px] md:min-h-[500px] text-white shadow-2xl relative overflow-hidden group">
              ...
              <p className="font-bold text-white/80 text-xs md:text-sm uppercase tracking-widest mb-12 absolute top-8 left-8 md:top-10 md:left-16">
                ( NEW WAY )
              </p>

              <div className="space-y-8 md:space-y-12 relative z-20 mt-8 md:mt-0">
                <div className="flex items-start gap-4 md:gap-6">
                  <div className="mt-1 md:mt-2 bg-white text-neon rounded-full p-1 w-6 h-6 md:w-8 md:h-8 flex items-center justify-center">
                    <Check
                      size={16}
                      strokeWidth={4}
                  ...
                  <div>
                    <h3 className="font-condensed text-4xl md:text-7xl uppercase leading-[0.9] mb-2 drop-shadow-md">
                      100% REVENUE
                    </h3>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div className="text-left relative z-10 order-2 lg:order-1">
                ...
                <p className="font-medium text-gray-600 text-lg md:text-xl leading-relaxed mb-8 md:mb-12 max-w-xl">
                  We don't build loyalty apps that nobody downloads.
                  <br />
                  We install a{" "}
                  <span className="text-black font-bold border-b-2 border-neon">
                    Native Brand Asset
                  </span>{" "}
                  directly into their Phone Wallet—right next to their Credit
                  Cards.
                </p>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                <div className="flex items-baseline gap-4 mb-6 md:mb-8">
                  <h3 className="text-7xl md:text-8xl font-condensed text-gray-100 group-hover:text-neon transition-colors duration-500">
                    01
                  </h3>
                  <span className="font-mono text-xs uppercase tracking-widest text-black bg-gray-100 px-3 py-1 rounded-full">
                    The Capture
                  </span>
                </div>
                <h4 className="text-5xl md:text-7xl font-condensed uppercase leading-[1.05] md:leading-[0.95] mb-6 md:mb-8">
                  Capture. Track.
                  <br />
                  Dominate.
                </h4>
                <p className="text-3xl md:text-5xl font-condensed uppercase tracking-tight text-black mb-8 md:mb-10">
                  Fast, easy, simple.
                </p>

                <ul className="space-y-6 md:space-y-8">
                  <li className="border-l-4 border-neon pl-6">
                    <span className="font-condensed text-xl md:text-2xl uppercase block mb-1">
                      Scan & Drop
                    </span>
                    <span className="text-base md:text-lg text-gray-500 font-medium">
                      QR Code. Instagram Link. Direct Message.
                      <br />
                      They are in within 3 seconds.
                    </span>
                  </li>
                  <li className="border-l-4 border-black pl-6">
                    ...
                    <span className="text-base md:text-lg text-gray-500 font-medium">
                      No passwords. No logins. Pure access.
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="bg-white rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-16 border border-gray-100 shadow-sm hover:shadow-2xl transition-shadow duration-500 group">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 leading-tight">
                  Don't give discounts. Give Status.
                </p>
                <p className="text-lg md:text-xl text-gray-500 mb-8 md:mb-12">
                  We track every Dirham spent on the card.
                </p>

                <div className="space-y-6 md:space-y-8">
                  <div className="flex items-center gap-4 md:gap-6">
                    <span className="font-condensed text-4xl md:text-5xl text-gray-200">
                      1
                    </span>
                    <div>
                      <span className="font-condensed text-2xl md:text-3xl uppercase block mb-1">
                        They Spend
                      </span>
                  ...
                  <div className="flex items-center gap-4 md:gap-6">
                    ...
                    <div>
                      ...
                      <span className="text-xs md:text-sm text-gray-400 uppercase tracking-wider">
                        Credits hit wallet instantly
                      </span>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 md:gap-6">
                    <span className="font-condensed text-4xl md:text-5xl text-neon">
                      3
                    </span>
                    <div>
                      <span className="font-condensed text-2xl md:text-3xl uppercase block mb-1 text-black">
                        They Ascend
                      </span>
                      <span className="text-xs md:text-sm text-gray-400 uppercase tracking-wider">
                        They chase the "Black Tier"
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div>
                  ...
                  <h2 className="text-5xl md:text-7xl font-condensed uppercase leading-[1.05] md:leading-[0.95] tracking-tighter mb-6 md:mb-8">
                    Bypass
                    <br />
                    <span className="text-black">The Noise</span>
                  </h2>
                  ...
                  <p className="text-2xl md:text-4xl font-bold text-black mb-4 md:mb-6 leading-tight">
                    Push Notifications have 78% higher open rates.
                  </p>
                  <p className="text-gray-500 text-base md:text-lg mb-8 md:mb-10">
                    Send unlimited notifications directly to the Lock Screen.
                  </p>
                </div>
        ...
        <section className="mb-24">
          ...
          <div className="w-full rounded-[2rem] md:rounded-[4rem] bg-black relative overflow-hidden flex flex-col items-center justify-center py-20 md:py-48 px-4 shadow-2xl">
            ...
            <div className="relative z-10 text-center">
              ...
              <h2 className="text-[18vw] md:text-[15vw] leading-[0.85] md:leading-[0.8] font-condensed uppercase text-white tracking-tighter drop-shadow-2xl mix-blend-overlay">
                This Is
                <br />
                <span className="text-neon mix-blend-normal">Unfair</span>
                <br />
                Advantage.
              </h2>
            </div>
          ...
          <div className="text-center mt-12 mb-24 md:mb-32 px-4 max-w-4xl mx-auto">
            <p className="text-xl md:text-4xl font-bold leading-relaxed text-black">
              While your competitors are sending flyers on WhatsApp that get
              ignored, you are building a Private Economy.
            </p>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            ...
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="font-medium text-gray-500 max-w-sm">
                  We are accepting a limited number of Flagship Partners this
                  quarter.
                </p>
              </div>
            </div>
          ...
          <div className="border-t border-gray-200 pt-12 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-12 font-sans">
            <div className="space-y-1">
              ...
              <a
                href="mailto:hello@az-ur.com"
                className="block text-xl md:text-2xl font-bold hover:text-neon transition-colors"
              >
                hello@az-ur.com
              </a>
            ...
            <div className="md:text-right">
              ...
              <p className="text-gray-400 mt-2 text-xs font-medium">
                © 2025 AZ:UR Infrastructure.
              </p>
              <p className="text-gray-400 mt-2 text-xs font-medium max-w-xs md:mx-auto">
                [AZ:UR] is a trading name and service operated by CALL SHIV AI
                DEVELOPING SERVICES, <br/>License No: 1581558, Dubai, UAE
              </p>
            </div>
          </div>
        </div>
